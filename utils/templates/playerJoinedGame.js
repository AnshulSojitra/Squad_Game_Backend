            ...
            <tr>
              <td style="padding:40px;color:#374151;">
                ...
                <p style="font-size:15px;line-height:1.6;">
                  Great news! <strong>${playerName}</strong> has joined your game on 
                  <b>BoxArena</b>. Here are the match details:
                </p>
                ...
                <table width="100%" cellpadding="10" cellspacing="0"
                  ...
                  <tr>
                    <td><strong>Joined Player</strong></td>
                    <td>${playerName}</td>
                  </tr>
                ...
                <p style="margin-top:25px;font-size:15px;">
                  Players are filling up fast! Get ready for an exciting match ⚽
                </p>
...
module.exports = playerJoinedGameEmail;
