            ...
            <tr>
              <td style="padding:40px;color:#374151;">
                ...
                <p style="font-size:15px;line-height:1.6;">
                  You have successfully left the following game on <b>BoxArena</b>.
                  The slot is now available for other players.
                </p>
                ...
                <p style="margin-top:25px;font-size:15px;">
                  If you'd like to play, you can always join another game anytime on BoxArena ⚽
                </p>
...
module.exports = gameLeftByPlayer;
